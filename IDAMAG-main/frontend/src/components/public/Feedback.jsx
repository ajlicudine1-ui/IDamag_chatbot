...
const CRITERIA = [
  {
    ...
    hint: "Layout, visual design, clarity",
  },
  {
    key: "ux",
    label: "User Experience",
    hint: "Ease of navigation and use",
  },
  {
    key: "completeness",
    label: "Data Completeness",
    hint: "Is information missing or thorough?",
  },
  {
    key: "accuracy",
    label: "Data Accuracy",
    hint: "Correctness of the figures shown",
  },
  {
    key: "accessibility",
    label: "Accessibility",
    hint: "Easy to reach for all stakeholders",
  },
];
...
const Feedback = () => {
  ...
  // ============================================================
  // LOAD DASHBOARD NAMES FROM SUPABASE REPORTS TABLE
  // ============================================================
  ...
  useEffect(() => {
    ...
    const loadReports = async () => {
      try {
        ...
        /*
         * Keep only reports with a valid title.
         */
        const validReports =
          data.filter(
            (report) =>
        ...
        console.error(
          "Unable to load dashboard names:",
          error
        );

        if (isMounted) {
          setReportsError(
            "Unable to load dashboards. Please refresh the page."
          );
        }
  ...
  const handleSubmit =
    async (e) => {
      ...
      /*
       * This is the selected reports.title value.
       */
      formData.append(
        ENTRY_IDS.dashboardName,
        dashboardName
      );
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    used solely to evaluate and
                    improve the i-DAMAG
                    Dashboard. Your name and
                    email are optional and used
                    only for feedback-related
                    communication, processed
                    under the Data Privacy Act
                    of 2012 (RA 10173).
                    Responses are kept
                    confidential and accessed
                    only by authorized
                    personnel.
                  </p>
